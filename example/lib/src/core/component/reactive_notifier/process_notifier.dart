...
class ProcessEnabled extends ProcessStatus {
  ProcessEnabled({String? message}) : super(message: message ?? "Enabled");
}

class ProcessDisabled extends ProcessStatus {
  ProcessDisabled({String? message}) : super(message: message ?? "Disabled");
}

class ProcessLoading extends ProcessStatus {
  ProcessLoading({String? message}) : super(message: message ?? "Loading");
}

class ProcessFailed extends ProcessStatus {
  ProcessFailed({String? message}) : super(message: message ?? "Error");
}

class ProcessSuccess extends ProcessStatus {
  ProcessSuccess({String? message}) : super(message: message ?? "Success");
}
