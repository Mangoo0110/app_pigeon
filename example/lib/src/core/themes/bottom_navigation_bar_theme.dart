...
class DBottomNavigationBarThemes {
  ...
  lightBottomNavTheme = BottomNavigationBarThemeData(
    backgroundColor: AppColors.light()
        .bottomNavigationBarColor, // Background color for the bottom navigation bar
    selectedItemColor:
        AppColors.light().primaryColor, // Color of the selected item
    unselectedItemColor:
        AppColors.light().inActiveButtonColor, // Color of unselected items
    ...
    unselectedIconTheme: IconThemeData(
      color: AppColors.light()
          .inActiveButtonColor, // Icon color for unselected items
    ...
    selectedLabelStyle: TextStyle(
      ...
      color:
          AppColors.light().primaryColor, // Text style for the selected label
    ),
    unselectedLabelStyle: TextStyle(
      ...
      color: AppColors.light()
          .inActiveButtonColor, // Text style for unselected labels
    ),
    showSelectedLabels:
        true, // Whether or not to show labels for selected items
    showUnselectedLabels:
        true, // Whether or not to show labels for unselected items
  ...
  static BottomNavigationBarThemeData
  darkBottomNavTheme = BottomNavigationBarThemeData(
    backgroundColor:
        Colors.blue, // Background color for the bottom navigation bar
    selectedItemColor: AppColors.dark().textColor, // Color of the selected item
    unselectedItemColor: AppColors.dark().textColor.withOpacity(
      .5,
    ...
    unselectedIconTheme: IconThemeData(
      color: AppColors.dark().textColor.withOpacity(
        .5,
