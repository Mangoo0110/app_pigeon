...
class DTabBarTheme {
  ...
  static TabBarThemeData lightTabBarTheme = TabBarThemeData(
    ...
    unselectedLabelColor: Color.from(
      alpha: 1,
      red: 0.349,
      green: 0.349,
      blue: 0.349,
    ), // Color of the unselected tab's label
    labelStyle: const TextStyle(
      fontSize: 13,
      fontFamily: "Poppins",
      fontWeight: FontWeight.normal,
    ), // Style of the selected tab's label
    unselectedLabelStyle: const TextStyle(
      fontSize: 13,
      fontFamily: "Poppins",
      fontWeight: FontWeight.normal,
    ), // Style of the unselected tab's label
  );
  ...
  static TabBarThemeData darkTabBarTheme = TabBarThemeData(
    ...
    dividerColor: AppColors.light().bottomNavigationBarColor,
    labelColor:
        AppColors.dark().primaryColor, // Color of the selected tab's label
    unselectedLabelColor: Color.from(
      alpha: 1,
      red: 0.349,
      green: 0.349,
