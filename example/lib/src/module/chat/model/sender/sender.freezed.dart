...
mixin _$Sender {
 ...
 String get id; String get name; String? get profileImage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sender&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.profileImage, profileImage) || other.profileImage == profileImage));
}
...
@override
String toString() {
  return 'Sender(id: $id, name: $name, profileImage: $profileImage)';
}
...
@useResult
$Res call({
 String id, String name, String? profileImage
});
...
/// Create a copy of Sender
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? profileImage = freezed,}) {
  return _then(Sender(
